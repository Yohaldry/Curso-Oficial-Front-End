...
let CerrarSesion = document.getElementById('btnSalir');
let BorrarCita = document.getElementById('btnBorrar');
let citas = [];
...
const borrarCita = () => {
    ...
    PersonaCita = document.getElementById('inputBuscar')

    if (PersonaCita.length >=1){

        localStorage.removeItem(PersonaCita)
    }
    
}

BorrarCita.addEventListener('click', borrarCita)
